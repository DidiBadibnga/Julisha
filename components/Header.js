    ...
    return (
        <header className="bg-white shadow py-2 flex items-center justify-between static z-50 w-full">
            <section className='flex space-x-2'>
                ...
                <section className="">
                    <button className="flex items-center py-2 justify-center px-2 rounded-md  bg-yellow-500 text-md text-white font-semibold hover:bg-yellow-700" onClick={() => router.push('/new_post')}>
